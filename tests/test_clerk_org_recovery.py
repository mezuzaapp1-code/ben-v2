"""Clerk organization context recovery v1: structured 403, no silent anonymous fallback for signed users."""
...
from auth.tenant_binding import TenantContext, validate_body_tenant_matches_context
...
def test_build_tenant_context_signed_no_org_raises():
...
def test_jwt_missing_org_council_returns_403(monkeypatch):
    def no_org(*_a, **_k):
        return {"sub": "usr", "email": "e@e.com", "org_id": None}
...
def test_get_threads_missing_org_returns_403():
    def no_org(*_a, **_k):
        return {"sub": "usr", "email": "e@e.com", "org_id": None}
