...
from services.media.contracts import ImageRequest, MediaProviderError, MAX_IMAGE_BYTES
...
class MediaService:
    ...
    async def tick(self, org):
        ...
        try:
            ...
            costs = account(result.usage, width=stored.width, height=stored.height)
