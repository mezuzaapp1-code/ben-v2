...
from services.media.contracts import ImageRequest, ImageResult
    ...
    return {
        ...
        **normalized,
        ...
        "provenance": {"output_origin": "provider_generated",
                       ...
                       "terms_reference": "https://ai.google.dev/gemini-api/terms",
                       "terms_reviewed_on": "2026-09-22"},
...
def result_observation(result: ImageResult) -> dict:
    ...
    return {"schema_version": VERSION, "provider": "google", "gateway": None,
            ...
            "duration_source": "client_observed", "usage_dimensions": result.usage,
